...
<aside class="bg-white-100 w-1/8 p-4">
...
<main class="bg-gray-100 flex-2 p-4">
    ...
    <div class="p-8 my-2">
        <h2 class="font-semibold text-2xl">Doctors</h2>
    </div>
    ...
    <div class="p-4">
        <div class="grid grid-cols-2 gap-4 mb-4">
            ...
            <div class="mx-3 my-25">
                <h3 class="font-semibold">List of Doctors</h3>
                <div>
                                    ...
                                    <table class="min-w-full text-left text-sm font-thin">
                                        ...
                                        <tbody>
                                            <tr class="border-b transition duration-300 ease-in-out hover:bg-neutral-100 dark:border-neutral-500 dark:hover:bg-neutral-600">
                                                ...
                                                <td class="whitespace-nowrap px-6 py-4">Mark Binas</td>
                                                <td class="whitespace-nowrap px-6 py-4">Ophthalmology</td>
                                                <td class="whitespace-nowrap px-6 py-4">Retina/Uveitis</td>
                                            </tr>
                                            <tr class="border-b transition duration-300 ease-in-out hover:bg-neutral-100 dark:border-neutral-500 dark:hover:bg-neutral-600">
                                                <td class="whitespace-nowrap px-6 py-4 font-medium">2</td>
                                                <td class="whitespace-nowrap px-6 py-4">Arnelle Napora</td>
                                                <td class="whitespace-nowrap px-6 py-4">Opthalmology</td>
                                                <td class="whitespace-nowrap px-6 py-4">Cataracts and Refractive Surgery</td>
                                            </tr>
                                            <tr class="border-b transition duration-300 ease-in-out hover:bg-neutral-100 dark:border-neutral-500 dark:hover:bg-neutral-600">
                                                <td class="whitespace-nowrap px-6 py-4 font-medium">3</td>
                                                <td class="whitespace-nowrap px-6 py-4">Shaina Bautista</td>
                                                <td class="whitespace-nowrap px-6 py-4">Pediatrics</td>
                                                <td class="whitespace-nowrap px-6 py-4">Pediatric Gastroenterologist</td>
                                            </tr>
                                            <tr class="border-b transition duration-300 ease-in-out hover:bg-neutral-100 dark:border-neutral-500 dark:hover:bg-neutral-600">
                                                <td class="whitespace-nowrap px-6 py-4 font-medium">4</td>
                                                <td class="whitespace-nowrap px-6 py-4">Larry Rouge</td>
                                                <td class="whitespace-nowrap px-6 py-4">Neurology</td>
                                                <td class="whitespace-nowrap px-6 py-4">General Neurology</td>
                                            </tr>
                                            <tr class="border-b transition duration-300 ease-in-out hover:bg-neutral-100 dark:border-neutral-500 dark:hover:bg-neutral-600">
                                                <td class="whitespace-nowrap px-6 py-4 font-medium">5</td>
                                                <td class="whitespace-nowrap px-6 py-4">Moon Chu</td>
                                                <td class="whitespace-nowrap px-6 py-4">Pharmacy</td>
                                                <td class="whitespace-nowrap px-6 py-4">Cardiology Pharmacy</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
        ...
        <div class="bg-white mx-4 pb-2">
            <h3 class="font-semibold">Past Doctors Appointment</h3>
            <div class="flex flex-col">
                <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                    <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                        <div class="overflow-hidden">
