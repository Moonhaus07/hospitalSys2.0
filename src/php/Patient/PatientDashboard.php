...
<body>
    ...
    <div class="flex h-screen">
        ...
        <main class="bg-gray-100 flex-2 p-4">
            ...
            <div class="p-8 my-4">
                <h2 class="font-semibold text-2xl">Welcome <span id="patientName">Patient</span>!</h2>
            </div>
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div class="mx-2 gap-72 ">
                        ...
                        <div class="bg-white rounded-lg shadow-md p-4 justify-center">
                            <h1 class="text-xl font-semibold">Appointment Info: <span id="appointmentID">Ophthalmology appointment</span> </h1>
